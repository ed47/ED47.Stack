...
namespace ED47.Communicator.Web
{
    /// <summary>
    ...
    public class DefaultValidationMessages
    {
        ...
        */
        ...
        {
            get { return Multilingual.N("sample.validation.InvalidEmail"); }
        }

        public static string equal_error
        {
            get { return Multilingual.N("sample.validation.Equality"); }
        }

        public static string length_error
        {
            get { return Multilingual.N("sample.validation.Length"); }
        }

        public static string exact_length_error
        {
            get { return Multilingual.N("sample.validation.ExactLength"); }
        }

        public static string notempty_error
        {
            get { return Multilingual.N("sample.validation.Required"); }
        }
        public static string notnull_error
        {
            get { return Multilingual.N("sample.validation.NotNull"); }
        }

        public static string lessthanorequal_error
        {
            get { return Multilingual.N("sample.validation.LEssThanOrEqual"); }
        }

        public static string notequal_error
        {
            get { return Multilingual.N("sample.validation.NotEqual"); }
        }

        public static string exclusivebetween_error
        {
            get { return Multilingual.N("sample.validation.Exclusive"); }
        }

        public static string greaterthanorequal_error
        {
            get { return Multilingual.N("sample.validation.GreaterOrEqual"); }
        }

        public static string greaterthan_error
        {
            get { return Multilingual.N("sample.validation.Greate"); }
        }
        ...
        {
            get { return Multilingual.N("sample.validation.PasswordLength"); }
        }
        ...
        public static string predicate_error
        {
            get
            {
                return Multilingual.N("sample.validation.Predicate");
            }
        }
        ...
        public static string regex_error
        {
            get
            {
                return Multilingual.N("sample.validation.Regex");
            }
        }
    }
}