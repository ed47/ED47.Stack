...
namespace ED47.Stack.Sample.BusinessEntities
{
    /// <summary>
    ...
    public class Message : BaseMessage
    {
        ...
        {
            UserContext.Instance.Repository.Add<Entities.Message, Message>(this); //This must match the Message entity that inherits BaseMessage. By convention we simply call it "Message".
        }
    }
}
