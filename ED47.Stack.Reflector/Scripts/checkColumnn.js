...
********************************************************************
NOTE: We Must integrate this style in order to view the checkbox
********************************************************************
...
.x-grid-checkheader {
    height: 14px;
    background-image: url('/content/images/elements/forms/unchecked.gif');
...
.x-grid-checkheader-checked {
    background-image: url('/content/images/elements/forms/checked.gif');
}
